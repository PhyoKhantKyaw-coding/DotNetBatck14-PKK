...
public class TravelService
{
    ...
    public async Task<ResponseModel> CreateTravelPackage(TravelPackageModel model)
    {
        ...
        var result = await _context.SaveChangesAsync();
        return result == 1 ?
            new ResponseModel { Success = "true", Message = "Travel package created successfully", Data = model } :
